...
class _HomePageState extends State<HomePage> {
  ...
  static String API_KEY = ""; // put your API key from weatherapi.com here
  ...
  // List of hold hourly and daily weather forecasts
  ...
  // Define function to fetch data through the API
